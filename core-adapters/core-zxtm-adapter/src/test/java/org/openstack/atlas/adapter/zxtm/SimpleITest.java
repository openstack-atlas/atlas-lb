...
public class SimpleITest extends ITestBase {
    ...
    public void updateLoadBalancer() throws Exception {
        try {
            ...
            zxtmAdapter.updateLoadBalancer(lb_1);
    ...
    private void createNodes() throws Exception {
        ...
        zxtmAdapter.createNodes(lb_1.getId(), lb_1.getAccountId(), lb_1.getNodes());
        ...
        zxtmAdapter.deleteNodes(lb_1.getAccountId(), lb_1.getId(), nodesToDelete);
    ...
    private void updateNodeConditionsToEnabled() throws Exception {
        for (Node node : lb_1.getNodes()) {
            ...
            zxtmAdapter.updateNode(lb_1.getAccountId(), lb_1.getId(), node);
        }
    ...
    private void shouldRollbackWhenSettingUnsupportedNodeWeight() throws Exception {
        ...
        try {
            zxtmAdapter.updateNode(lb_1.getAccountId(), lb_1.getId(), node_1_1);
        } catch (Exception e) {
    ...
    private void updateNodeWeights() throws Exception {
        ...
        zxtmAdapter.updateNode(lb_1.getAccountId(), lb_1.getId(), node_1_1);
        zxtmAdapter.updateNode(lb_1.getAccountId(), lb_1.getId(), node_1_2);
    ...
    private void updateSessionPersistence() throws Exception {
        ...
        zxtmAdapter.setSessionPersistence(lb_1.getId(), lb_1.getAccountId(), persistence);
    ...
    private void deleteSessionPersistence() throws Exception {
        ...
        try {
            zxtmAdapter.deleteSessionPersistence(lb_1.getAccountId(), lb_1.getId());
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
    ...
    public void updateConnectionThrottle() throws Exception {
        ...
        zxtmAdapter.updateConnectionThrottle(lb_1.getId(), lb_1.getAccountId(), throttle);
    ...
    private void updateHttpHealthMonitor() throws Exception {
        ...
        zxtmAdapter.updateHealthMonitor(lb_1.getId(), lb_1.getAccountId(), monitor);
    ...
    private void deleteHttpHealthMonitor() throws Exception {
        zxtmAdapter.deleteHealthMonitor(lb_1.getAccountId(), lb_1.getId());
    ...
    private void updateHttpsHealthMonitor() throws Exception {
        ...
        zxtmAdapter.updateHealthMonitor(lb_1.getAccountId(), lb_1.getId(), monitor);
